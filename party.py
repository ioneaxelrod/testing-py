...
def is_mel(name, email):
    ...
    >>> is_mel("Mel Melitpolski", "something@something.com")
    True

    >>> is_mel("dafdafd", "mel@ubermelon.com")
    True

    >>> is_mel("dlafkjdaf", "lkdajflajdf")
    False
...
def most_and_least_common_type(treats):
    ...
    >>> treats = [{'type': 'dessert'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}]
    >>> most_and_least_common_type(treats)
    ('dessert', 'dessert')

    >>> treats = [{'type': 'drink'}, {'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'appetizer'}]
    >>> most_and_least_common_type(treats)
    ('appetizer', 'drink')
